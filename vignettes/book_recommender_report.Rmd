...
To install the Book Recommender app from GitHub and launch it locally:

```{r install-run, eval=FALSE, echo=TRUE}
...
Alternatively, if you want to open the full project as an RStudio project:
...
# Then run this inside the project directory
devtools::install()
bookrecommender::run_app()
```
